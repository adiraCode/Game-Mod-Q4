...
idCVar pm_jumpheight(				"pm_jumpheight",			"150",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "approximate hieght the player can jump" ); //changed from 48 to 150
...
// RAVEN BEGIN
idCVar pm_speed(					"pm_speed",					"500",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while running" ); //changed from 160 to 500
